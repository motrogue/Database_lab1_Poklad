...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=3917804363ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"ru",server:"1",table:"",db:"",token:"503763302561696f50512b5e2a3b4465",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Обзор",pma_text_left_default_tab:"Структура",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"cookie",user:"ais_poklad5495_cinemapark"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%91%D0%B8%D0%BB%D0%B5%D1%82">`ais_poklad5495_cinemapark`.`Билет`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%9C%D0%B5%D1%81%D1%82%D0%BE">`ais_poklad5495_cinemapark`.`Место`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%A1%D0%B5%D0%B0%D0%BD%D1%81">`ais_poklad5495_cinemapark`.`Сеанс`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%A6%D0%B5%D0%BD%D0%B0">`ais_poklad5495_cinemapark`.`Цена`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%97%D0%B0%D0%BB">`ais_poklad5495_cinemapark`.`Зал`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ais_poklad5495_cinemapark&table=%D0%A4%D0%B8%D0%BB%D1%8C%D0%BC">`ais_poklad5495_cinemapark`.`Фильм`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="503763302561696f50512b5e2a3b4465">
